...
def get_color_scheme():
    ...
    color_scheme = simpledialog.askstring(
        "color-scheme",
        "Welcome to Wordle! Would you like to play with the color-blind scheme?\n Enter 'yes' or 'no':",
    )

    # Check if the user entered a valid option
    if color_scheme and color_scheme.lower() in ("yes", "no"):
